...
<p align="center">
  ...
  <br>
  <em>Figure 1:  End-to-end computational workflow of the PySole solver processing pipeline. <i>Click diagram to view in high resolution.</i></em>
</p>
...
<p align="center">
  ...
  <br>
  <em>Figure 2: Overview of PySole package submodules, class structure, and core processing functions. Solver functions and related submodules are color-coded. <i>Click diagram to view in high resolution.</i>.</em>
</p>
